...
const nextAfterCorrectorInstallation = ({
  datalogger,
  meterType,
  meterPressure,
}) => {
...
const generateScreenInstancesForStreams = (numberOfStreams) => {
  ...
  for (let i = 0; i < numberOfStreams; i++) {
    ...
    const streamScreens = [
      ...
      {
        name: `ActiveRegulatorPage-${i}`,
        component: ActiveRegulatorPage,
        title: `Active Regulator ${i + 1}`,
      },
      {
        name: `ReliefRegulatorPage-${i}`,
        component: ReliefRegulatorPage,
        title: `Relief Regulator ${i + 1}`,
      },
      {
        name: `WaferCheckPage-${i}`,
        component: WaferCheckPage,
        title: `Wafer Check ${i + 1}`,
      },
    ];
...
const ExistingmeterBadge = (meterType) =>
  meterType === 'Diaphragm' ? 'ExistingMeterIndex' : 'ExistingMeterDataBadge';
const InstalledmeterBadge = (meterType) =>
  meterType === 'Diaphragm' ? 'InstalledMeterIndex' : 'InstalledMeterDataBadge';
    ...
    <Stack.Navigator>
      <Stack.Screen
        ...
        initialParams={{
          ...
          nextScreen: 'AssetSelectGatewayScreenIntial',
        }}
      />
      <Stack.Screen
        name="AssetSelectGatewayScreenIntial"
        component={AssetSelectGatewayScreen}
        initialParams={{ pageRoute: 1 }}
      />
      <Stack.Screen
        ...
        initialParams={{
          ...
          nextScreen: 'ExistingMeterGatewayScreen1',
        }}
      />
      <Stack.Screen
        name="ExistingMeterGatewayScreen1"
        component={MeterGatewayScreen}
        initialParams={{ pageRoute: 1, pageflow: 1 }}
      />
      <Stack.Screen
      ...
      <Stack.Screen
        ...
        initialParams={{
          title: 'Ecv Photo',
          photoKey: 'EcvPhoto',
          nextScreen: 'ExistingCorrectorGatewaySreen',
        }}
      />
      <Stack.Screen
        name="ExistingMeterGatewayScreen2"
        component={MeterGatewayScreen}
        initialParams={{ pageRoute: 1, pageflow: 2 }}
      />
      <Stack.Screen
        ...
        initialParams={{
          ...
          nextScreen: () =>
            nextAfterCorrectorRemoval({ meter, corrector, datalogger }),
        }}
      />
      <Stack.Screen
        name="ExistingCorrectorGatewaySreen"
        component={CorrectorGateway}
        initialParams={{ pageRoute: 1 }}
      />
      <Stack.Screen
        ...
        initialParams={{
          ...
          nextScreen: 'AssetSelectGatewayScreenFinal',
        }}
      />
      <Stack.Screen
        name="AssetSelectGatewayScreenFinal"
        component={AssetSelectGatewayScreen}
        initialParams={{ pageRoute: 2 }}
      />

      <Stack.Screen
        name="InstalledMeterDetails"
        component={MeterDetailsPage}
        initialParams={{
          title: 'Installed Meter Details',
          nextScreen: 'EcvToMovphoto',
        }}
      />
      <Stack.Screen
        name="EcvToMovPhoto"
      ...
      <Stack.Screen
        ...
        component={MeterGatewayScreen}
        initialParams={{ pageRoute: 2, pageflow: 1 }}
      />
      <Stack.Screen
        name="InstalledMeterDataBadge"
        component={GenericPhotoPage}
        initialParams={{
          title: 'Installed Meter data badge',
          photoKey: 'InstalledMeterDataBadge',
          nextScreen: 'InstalledMeterIndex',
        }}
      />
      <Stack.Screen
        name="InstalledMeterIndex"
        component={GenericPhotoPage}
        initialParams={{
          title: 'Installed Meter index',
          photoKey: 'InstalledMeterIndex',
          nextScreen: 'InstalledMeterPhoto',
        }}
      />
      <Stack.Screen
        name="InstalledMeterPhoto"
        component={GenericPhotoPage}
        initialParams={{
      ...
      <Stack.Screen
        ...
        component={MeterGatewayScreen}
        initialParams={{ pageRoute: 2, pageflow: 2 }}
      />
      <Stack.Screen
        name="InstalledCorrectorDetails"
        component={CorrectorDetailsPage}
        initialParams={{
          title: 'Installed Corrector Details',
          nextScreen: 'CorrectorGatewayScreen',
        }}
      />
      <Stack.Screen
        name="CorrectorGatewaySreen"
        component={CorrectorGateway}
        initialParams={{ pageRoute: 2 }}
      />

      <Stack.Screen
        name="InstalledDataLoggerDetails"
        component={DataLoggerDetailsPage}
        initialParams={{
          title: 'Installed DataLogger Details',
          nextScreen: 'DataLoggerGatewayScreen',
        }}
      />
      <Stack.Screen
        name="DataLoggerGatewayScreen"
        component={DataLoggerGatewayScreen}
      />
