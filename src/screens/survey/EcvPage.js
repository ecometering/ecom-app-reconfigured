...
export default function EcvPage() {
  ...
  const nextPressed = async () => {
    ...
    if (!type) {
      EcomHelper.showInfoMessage("ECV Type is required.Please enter the ECV Type.");
    } else if (!height) {
      EcomHelper.showInfoMessage("ECV Height is required.Please enter the ECV Height.");
    } else if (!size) {
      EcomHelper.showInfoMessage("ECV Size is required.Please enter the ECV Size."  );
    } else if (!dfkw) {
