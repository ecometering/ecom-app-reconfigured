...
export default function MovPage() {
  ...
  const nextPressed = async () => {
    ...
    if (!type) {
      EcomHelper.showInfoMessage("Mov Type is required.Please enter the Mov Type.");
    } else if (!height) {
      EcomHelper.showInfoMessage("Mov Height is required.Please enter the Mov Height.");
    } else if (!size) {
      EcomHelper.showInfoMessage("Mov Size is required.Please enter the Mov Size."  );
    } else if (!dfkw) {
